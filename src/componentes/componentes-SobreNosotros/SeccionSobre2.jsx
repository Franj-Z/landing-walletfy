            ...
            <section className='container'>
                    <div className='row position-relative'>
                        <div className='col-12 col-lg-6 texto-s'>
                            <h2 className='h3 h-s'>En Walletfy nuestro objetivo principal es brindarle las herramientas necesarias a las personas para su <b>capacitación en el mundo de las finanzas.</b></h2>
                            ...
                            <p className='p-s'>Lo que comenzó como un simple seguimiento de gastos para un pequeño grupo de personas se convirtió en una aplicación de finanzas personales que aporta belleza a las finanzas de cientos de miles de usuarios en Argentina.</p>
                    ...
                    <div className='circle grey small'>
                        <div className='row d-2 position-relative'>
                            ...
                            <div className='col-12 col-lg-6 texto-s my-5'>
                                <h2 className='h3 h-s'>Queremos que tu vida financiera esté libre de estrés.</h2>
                                <p className='p-s'>Walletfy te ayuda a poner tus finanzas en forma para que no tengas que preocuparte por cada dólar que gastás. Si sabés cuánto y en qué gastás, es más fácil cambiar tus hábitos financieros, si sentís que eso es lo que necesitas.</p>
