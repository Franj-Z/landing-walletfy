                ...
                <div className='row'>
                    ...
                    <div className='col-12 col-lg-8'>
                        ...
                        <ul className='wallet-h'>
                            <li className='wallet-li'>Profesional: Todos nuestros cursos integrales, con ejemplos del mundo real, han sido desarrollados por expertos para convertirte en un experto.</li>
                            <li className='wallet-li'>Personalizado: El feed en la aplicación te brinda cursos personalizados, cuestionarios interesantes, categorías de glosario útiles, videos educativos que despiertan la curiosidad para satisfacer tus necesidades y habilidades.</li>
